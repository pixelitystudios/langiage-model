...
class chatbot(object):
    ...
    def __init__(self):
        self.input_word2idx = np.load('./model/vectors/word-input-word2idx.npy').item()
        self.input_idx2word = np.load('./model/vectors/word-input-idx2word.npy').item()
        self.target_word2idx = np.load('./model/vectors/word-target-word2idx.npy').item()
        self.target_idx2word = np.load('./model/vectors/word-target-idx2word.npy').item()
        context = np.load('./model/vectors/word-context.npy').item()
